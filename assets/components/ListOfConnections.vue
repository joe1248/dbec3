...
<div class="centered" id="app">
    ...
    <fieldset class="fieldset one_line">
        <legend class="legend">Your DB Servers.{{greeting}} Wolrd</legend>
        <table style="width:400px;" class="html_example">
            <tr>
                <td class="centered" style="width:20px;">
                    <div id="td_connection_status_sql_id" class="connection_statuses">&nbsp;</div>
                </td>
